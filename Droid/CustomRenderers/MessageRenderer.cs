	...
	public class MessageRenderer : ViewCellRenderer
	{
		protected override Android.Views.View GetCellCore(Cell item, Android.Views.View convertView, ViewGroup parent, Context context)
		{
			...
			if (textMsgVm != null)
			{
				...
				{
					var template = (LinearLayout)inflatorservice.Inflate(textMsgVm.IsMine ? Resource.Layout.item_row : Resource.Layout.item_row, null, false);
					//template.FindViewById<TextView>(Resource.Id.timestamp).Text = DateTime.Now.Hour.ToString() + ":" + DateTime.Now.Minute.ToString() + ":" + DateTime.Now.Second.ToString();
